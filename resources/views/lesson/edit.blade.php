...
<div class="container mt-5 mb-5">
    ...
    <form action="{{ route('lesson.update', $lesson->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="video_url" name="video_url" value="{{ $lesson->video_url }}">
        </div>
        ...
        <div class="form-group form-check  my-3">
            <input type="checkbox" class="form-check-input" id="is_published" name="is_published" {{ $lesson->is_published ? 'checked' : '' }}>
        ...
        <button type="submit" class="mt-3 btn btn-primary">Actualizare lectien</button>
    </form>
</div>
</div>
</div>
