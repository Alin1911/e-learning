...
<div class="container mt-5 bg-light p-3 shadow">
    ...
    <p>
        Dacă aveți întrebări, sugestii sau comentarii, vă rugăm să ne contactați folosind formularul de mai jos sau prin e-mail la <a href="mailto:suport@platforma-elearning.ro">suport@platforma-elearning.ro</a>.
    </p>
    <form>
        <div class="mb-3">
